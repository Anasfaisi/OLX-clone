            ...
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <div className="mt-2">
                  ...
                  <p className=" text-center text-base font-medium mt-4">Help us become one of the safest places <br /> to buy and sell </p>
                  <div className="flex border-2 border-black p-2 rounded-md cursor-pointer">
                    <img src={phone}className="w-10 h-10" alt="" />
                    <h1 className="font-semibold ml-3 mt-3"> Continue with Phone </h1>
                  </div>
